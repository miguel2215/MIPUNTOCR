...
function renderSettings() {
  ...
  const cloudPanel = s.cloudLinked
    ? `<div class="panel" style="margin-top:14px"><strong>Nube</strong><p class="muted">Conectado a Supabase · ${esc(s.email || "")}</p><p class="muted">Cuenta y negocio están vinculados a la nube. La sincronización de productos, ventas y clientes es el siguiente paso.</p></div>`
