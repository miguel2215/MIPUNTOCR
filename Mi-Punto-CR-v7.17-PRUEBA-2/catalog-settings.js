...
window.openProPlans = () => {
  modal(`<h3>⭐ Mi Punto CR Pro</h3><p class="muted">Elige cómo quieres proteger y hacer crecer tu negocio.</p><div class="pro-plan-list"><button class="type-choice"><strong>Mensual</strong><small>Pro completo · precio por definir</small></button><button class="type-choice"><strong>Trimestral</strong><small>Pro completo · precio por definir</small></button><button class="type-choice"><strong>Anual</strong><small>Pro completo · precio por definir</small></button></div><div class="setup-note" style="margin-top:12px">También podrás activar Pro con un código promocional único de un solo uso.</div><button class="btn ghost full" style="margin-top:12px" onclick="closeModal()">Cerrar</button>`);
};
