...
gradle = gradle.replace(/versionCode\s+\d+/, 'versionCode 744');
gradle = gradle.replace(/versionName\s+["'][^"']+["']/, 'versionName "7.44.0"');
await writeFile(gradlePath, gradle, 'utf8');

console.log('Android preparado: cámara + OAuth deep link + versionCode 744 + versionName 7.44.0');
