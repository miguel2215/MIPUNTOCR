...
function renderSettings() {
  ...
  const cloudPanel = s.cloudLinked
    ? `<div class="panel" style="margin-top:14px"><strong>Nube</strong><p class="muted">Conectado a Supabase · ${esc(s.email || "")}</p><p class="muted">Cuenta y negocio ya están en la nube. Productos, ventas y clientes se migrarán en la siguiente etapa.</p><button class="btn ghost" onclick="logoutOwner()">Cerrar sesión</button></div>`
