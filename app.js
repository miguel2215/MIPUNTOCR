...
const BRAND = {
  ...
  vertical: "./assets/brand/logo-vertical.png",
...
function shell(content, active = "home") {
  ...
  return `<main class="shell">
    <header class="topbar"><div class="brand brand-with-icon">${brandIcon("brand-icon")}<div><h1>${esc(state.settings.businessName)}</h1><p>Mi Punto CR</p></div></div><div class="status-row">${badge()}</div></header>
